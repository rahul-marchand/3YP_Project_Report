...
This project addresses the identified gap by developing a headset-based oculomotor assessment system designed to \textbf{supplement, not replace,} existing non-expert screening tools such as the CRT6 with objective, quantitative measurement. Rather, it strengthens the non-expert screening pathway by adding an automated, cooperation-independent measurement where currently only subjective observation is available.
