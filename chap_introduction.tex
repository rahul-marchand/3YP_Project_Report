...
The remainder of this report is organised as follows: \Cref{chapter:background} establishes the scientific foundation for oculomotor biomarkers in \ab{mtbi} and reviews existing diagnostic approaches. \Cref{chapter:headset} presents the headset hardware design, covering optics, electronics, ergonomics, and assembly. \Cref{chapter:software} describes the software architecture, data collection pipeline, and analysis algorithms. \Cref{chapter:results} presents the concussion detection protocol and experimental results.
