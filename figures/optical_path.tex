...
\begin{tikzpicture}[x=1mm, y=1mm, line cap=round, line join=round, font=\sffamily]
  ...
  % --- IR illumination: LED stubs -> eye pupil ---
  \draw[nirc, line width=\lwIR, opacity=0.85]
    (\irRingX,  \irRingY) -- (\pupilXcoord, 0);
  \draw[nirc, line width=\lwIR, opacity=0.85]
    (\irRingX, -\irRingY) -- (\pupilXcoord, 0);
  % Midpoint direction indicators (arrow centred at halfway point, pointing into eye)
  \draw[nirc, -{Stealth[length=2.3mm, width=1.8mm]}, line width=\lwIR, opacity=0.85]
    ($(\irRingX, \irRingY)!0.42!(\pupilXcoord,0)$) -- ($(\irRingX, \irRingY)!0.58!(\pupilXcoord,0)$);
  \draw[nirc, -{Stealth[length=2.3mm, width=1.8mm]}, line width=\lwIR, opacity=0.85]
    ($(\irRingX,-\irRingY)!0.42!(\pupilXcoord,0)$) -- ($(\irRingX,-\irRingY)!0.58!(\pupilXcoord,0)$);
