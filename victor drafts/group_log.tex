...
\subsubsection*{Sunday 3 November 2024}

\paragraph{Aim}
Present Week 3 progress to supervisors and collect detailed feedback for the next presentation cycle.

\paragraph{What Happened}
Delivered presentation on project progress. Received feedback from supervisors on areas requiring improvement.

Immediately after the presentation, worked with the team to annotate the slides with clear, actionable feedback. Documented three main priorities for improvement:
\begin{enumerate}
    \item Improve slide quality: include diagrams, plots, and figures with proper source citations
    \item Provide medical research justification for our approach and biomarker selection
    \item State more clearly our target customer and the specific problem we are trying to solve
\end{enumerate}

\paragraph{What's Next}
\begin{itemize}
    \item Address feedback in stages over coming weeks
    \item Focus on medical literature research to strengthen justification
    \item Begin software and ML development planning
\end{itemize}

\subsection{Week 4: Software Planning and Hardware Development}

\subsubsection*{Friday 8 November 2024}

\paragraph{Aim}
Begin planning machine learning and software components for data collection whilst the team develops hardware solutions.

\paragraph{What Happened}
The team developed a one-way mirror concept using plate beamsplitters to achieve coaxial alignment of camera and LED stimulus. Two plate beamsplitters with different specifications were ordered for testing.

Began planning the machine learning architecture and software infrastructure needed for the data collection system. Considered requirements for pupil detection algorithms, real-time processing constraints, and the data pipeline from image capture through to analysis output.

Started outlining software components: camera interface, stimulus control, data recording, and preliminary ML model structure for pupil tracking.

\paragraph{What's Next}
\begin{itemize}
    \item Continue ML and software development planning
    \item Research medical literature to strengthen project justification
    \item Support beamsplitter testing when components arrive
\end{itemize}

\subsection{Week 5: Medical Research and Report Development}

\subsubsection*{Wednesday 13 November 2024}

\paragraph{Aim}
Continue research for clearly defining project objectives and strengthen the medical evidence base for our approach.

\paragraph{What Happened}
Continued research aimed at clearly defining our project objective. Focused on gathering evidence and straightening out our argument for why this mTBI screening tool is needed and how pupillometry addresses the clinical gap.

Researched the underlying biology of mTBI and pupillary responses, reviewing literature on the neurological pathways affected by concussion and how these manifest as measurable oculomotor dysfunction. This biological understanding is essential for justifying our biomarker selection.

Wrote up current project state into the report, documenting where we were at with biomarker selection rationale and target user definition. Integrated the research findings to strengthen the clinical justification sections.

\paragraph{What's Next}
\begin{itemize}
    \item Test beamsplitters when they arrive
    \item Continue developing storyline for presentation
    \item Further refine report sections
\end{itemize}

\subsection{Week 6: Hardware Testing and Presentation Planning}

\subsubsection*{Sunday 17 November 2024}

\paragraph{Aim}
Test beamsplitter hardware and develop clear, concise presentation storyline.

\paragraph{What Happened}
Participated in testing the beamsplitters that arrived. Worked with the team on data collection to evaluate the optical setup and validate system performance.

Focused on straightening up the storyline for our upcoming presentation. Aimed for a concise, clear argument that would directly address the Week 3 feedback: starting with a well-defined problem and target customer, providing strong medical justification for pupillometry, and explaining our technical approach with improved visual aids.

Worked on structuring the presentation narrative to flow logically from clinical need through our solution architecture to implementation progress.

\paragraph{What's Next}
Begin developing Week 7 presentation materials incorporating the refined storyline.

\subsection{Week 7: Presentation Development and Refinement}

\subsubsection*{Wednesday 20 November 2024}

\paragraph{Aim}
Begin developing Week 7 presentation, systematically addressing all feedback received in Week 3.

\paragraph{What Happened}
Started working on the Week 7 presentation slides, using the annotated feedback from Week 3 as a checklist. Focused on implementing the three main improvements: enhancing slide quality with diagrams and figures, strengthening medical research justification, and clearly defining our target customer and problem statement.

Began developing content that directly addressed each feedback point, ensuring the presentation would demonstrate clear progress in response to supervisor guidance.

\paragraph{What's Next}
Finalise presentation with diagrams, images, and source citations, then rehearse as a team.

\subsubsection*{Friday 22 November 2024}

\paragraph{Aim}
Complete presentation materials and prepare for delivery through team rehearsal.

\paragraph{What Happened}
Finalised Week 7 presentation with diagrams, images, and proper source citations throughout. Ensured all statistics and clinical claims were attributed to peer-reviewed sources to address the feedback on evidence quality.

Conducted team rehearsal to practice delivery and timing. Discovered the presentation was over time, so worked with the team to cut down sections whilst maintaining the core argument and ensuring all three feedback priorities were still addressed.

Made difficult decisions about what content to trim whilst preserving the logical flow and key messages that would demonstrate we had responded to supervisor feedback.

\paragraph{What's Next}
Deliver Week 7 presentation and incorporate any new feedback into ongoing development.

\subsection*{Note on Report Status}

The main project report has not been substantially updated since approximately Week 5 (mid-November). Since then, our argument has been significantly solidified through the Week 7 presentation development process, and numerous figures, diagrams, and supporting evidence have been produced and sourced. These improvements are currently reflected in the presentation slides and will be integrated into the written report by the end of Week 8. The presentation materials represent the current state of our refined clinical justification, technical approach, and visual documentation.
