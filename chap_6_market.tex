...
This chapter analyses the market opportunity for a headset-based pupillometry system for \ab{mtbi} screening, identifies the key stakeholders and users, and articulates the value proposition for each target segment.


\section{Market Segmentation}
\label{sec:ent-market-analysis}

\todo{Suleiman: Draft this section. Frame the product as a portable pupillometry-based headset for rapid concussion/mTBI assessment, aimed at settings where quick triage matters and access to specialist neurodiagnostics is limited.}
