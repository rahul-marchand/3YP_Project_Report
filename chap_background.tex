...
This chapter establishes the scientific and technical foundation for the screening system presented in this report. It begins by defining \ab{mtbi} and the pathological mechanisms that make it difficult to detect with conventional imaging (\Cref{sec:bg-mtbi}). It then reviews existing diagnostic approaches and their limitations for field deployment (\Cref{sec:bg-existing}), before presenting the oculomotor biomarkers that motivate the system design (\Cref{sec:bg-oculomotor}). Finally, it surveys prior engineering work on automated oculomotor assessment (\Cref{sec:bg-engineering}).
