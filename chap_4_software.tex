...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/filter_comparison}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/gaussian_filter_optimisation}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/optimal_gaussian_filter}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/filter_effects}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/mpiigaze_per_subject_mae}
