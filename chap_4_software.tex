...
\begin{figure}[htbp]
    \centering
    \resizebox{\textwidth}{!}{\input{figures/data_pipeline_tikz}}
    \caption{Software data flow in the smooth pursuit trial. Training mode retains raw eye images for model development, whereas testing mode performs on-device inference and discards images after gaze-angle extraction.}
...
\subsection{Training Specific Technology}
