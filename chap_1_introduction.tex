...
This project develops a headset-based automated oculomotor screening system designed to \textbf{supplement, not replace,} existing non-expert screening tools such as the CRT6. The rationale for oculomotor screening as a modality is presented in \Cref{chapter:background}; the headset and software design are detailed in \Cref{chapter:headset} and \Cref{chapter:software} respectively.
